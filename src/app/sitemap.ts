...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: {
    ...
    { path: '/tools/video-inspector', lastModified: '2026-05-19', changeFrequency: 'monthly', priority: 0.8 },
    ...
    { path: '/tools/ai-title-generator', lastModified: '2026-05-19', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/tools/ai-description-generator', lastModified: '2026-05-19', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/tools/ai-tag-generator', lastModified: '2026-05-19', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/tools/thumbnail-size-guide', lastModified: '2026-05-19', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/tools/revenue-calculator', lastModified: '2026-05-19', changeFrequency: 'monthly', priority: 0.8 },
    // Free SEO tools
