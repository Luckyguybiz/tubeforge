...
const CREATOR_POOLS: Record<string, CreatorInfo[]> = {
  ...
  RU: [
    { name: 'танцуй_с_аней', id: 'dance_anya', avatar: null },
    { name: 'повар_иван', id: 'chef_ivan', avatar: null },
    { name: 'юмор_макс', id: 'humor_max', avatar: null },
    { name: 'спорт_даша', id: 'sport_dasha', avatar: null },
    { name: 'красота_лиза', id: 'beauty_liza', avatar: null },
    { name: 'наука_просто', id: 'science_simple', avatar: null },
    { name: 'котики_мир', id: 'cats_world', avatar: null },
    { name: 'музыка_вова', id: 'music_vova', avatar: null },
    { name: 'путешествия_рус', id: 'travel_rus', avatar: null },
    { name: 'гейминг_кирилл', id: 'gaming_kirill', avatar: null },
    { name: 'стиль_катя', id: 'style_katya', avatar: null },
    { name: 'фитнес_алёна', id: 'fitness_alena', avatar: null },
    { name: 'diy_настя', id: 'diy_nastya', avatar: null },
    { name: 'рецепты_мама', id: 'recipes_mama', avatar: null },
    { name: 'смешно_тв', id: 'funny_tv', avatar: null },
  ],
  KZ: [
    { name: 'алматы_влог', id: 'almaty_vlog', avatar: null },
    { name: 'би_кулинария', id: 'bi_cooking', avatar: null },
    { name: 'астана_стиль', id: 'astana_style', avatar: null },
    { name: 'қазақ_юмор', id: 'kazakh_humor', avatar: null },
    { name: 'спорт_қз', id: 'sport_kz', avatar: null },
    { name: 'дала_саяхат', id: 'steppe_travel', avatar: null },
    { name: 'гейм_қз', id: 'game_kz', avatar: null },
    { name: 'сұлулық_кз', id: 'beauty_kz', avatar: null },
    { name: 'өнер_кз', id: 'art_kz', avatar: null },
    { name: 'фитнес_кз', id: 'fitness_kz', avatar: null },
  ],
  US: [
