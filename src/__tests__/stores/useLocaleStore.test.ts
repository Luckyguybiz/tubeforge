...
describe('useLocaleStore', () => {
  ...
  describe('setLocale', () => {
    ...
    it('should translate keys in English after switching', () => {
      useLocaleStore.getState().setLocale('en');
      const { t } = useLocaleStore.getState();
      expect(t('nav.dashboard')).toBe('Dashboard');
    });

    it('should switch to Kazakh locale', () => {
    ...
    it('should fall back to Russian for missing locale keys', () => {
      useLocaleStore.getState().setLocale('en');
      const { t } = useLocaleStore.getState();
    ...
    it('should switch back to Russian', () => {
      useLocaleStore.getState().setLocale('en');
  ...
  describe('locale persistence', () => {
    it('should preserve locale across getState calls', () => {
      useLocaleStore.getState().setLocale('en');
