  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', background: '#0e0e14', borderRadius: 14, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: '35%', background: '#141420', borderRight: '1px solid rgba(255,255,255,0.06)', padding: 16, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ width: '100%', height: 56, borderRadius: 8, background: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.06)', marginBottom: 12, padding: 10 }}>
          <div style={{ width: '90%', height: 6, borderRadius: 3, background: 'var(--bg-secondary)', marginBottom: 6 }} />
          <div style={{ width: '60%', height: 6, borderRadius: 3, background: 'var(--bg-secondary)' }} />
        </div>
        <div style={{ fontSize: 9, color: 'var(--fg-tertiary)', marginBottom: 6 }}>Style</div>
        ...
        <div style={{ fontSize: 9, color: 'var(--fg-tertiary)', marginBottom: 6 }}>Aspect Ratio</div>
      ...
      <div style={{ position: 'absolute', left: '35%', top: 0, right: 0, bottom: 0, display: 'flex', flexDirection: 'column', padding: 16, gap: 8 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
          ...
          <div style={{ fontSize: 9, color: 'var(--fg-tertiary)' }}>Generated Results</div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, flex: 1 }}>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ width: '60%', height: '40%', borderRadius: 4, background: 'var(--bg-secondary)' }} />
              {i === 0 && (
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', background: '#0e0e14', borderRadius: 14, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 32, background: '#141420', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', padding: '0 12px', gap: 8 }}>
        ...
        <div style={{ width: 8, height: 8, borderRadius: 4, background: '#22c55e' }} />
        <div style={{ marginLeft: 12, fontSize: 9, color: 'var(--fg-tertiary)' }}>Scene Editor</div>
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 6 }}>
          {['Cut', 'Trim', 'Export'].map(b => (
            <div key={b} style={{ padding: '2px 8px', borderRadius: 4, background: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.06)', fontSize: 8, color: 'rgba(255,255,255,0.35)' }}>{b}</div>
          ))}
        </div>
      </div>
      {/* Left panel — scenes */}
      <div style={{ position: 'absolute', left: 0, top: 32, bottom: 48, width: '28%', background: '#111118', borderRight: '1px solid rgba(255,255,255,0.06)', padding: 10, display: 'flex', flexDirection: 'column', gap: 6 }}>
        <div style={{ fontSize: 9, color: 'var(--fg-tertiary)', marginBottom: 2 }}>Scenes</div>
        {[1, 2, 3, 4].map(n => (
          <div key={n} style={{
      ...
      <div style={{ position: 'absolute', left: '28%', top: 32, right: '25%', bottom: 48, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 12 }}>
        <div style={{ width: '100%', height: '100%', borderRadius: 10, background: 'linear-gradient(135deg, #1a1a2e, #16213e)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
          ...
          <div style={{ position: 'absolute', bottom: 8, left: 8, right: 8, display: 'flex', alignItems: 'center', gap: 4 }}>
            <div style={{ fontSize: 8, color: 'var(--fg-tertiary)' }}>0:04</div>
            ...
            <div style={{ fontSize: 8, color: 'var(--fg-tertiary)' }}>0:12</div>
          </div>
        </div>
      </div>
      {/* Right panel — effects */}
      <div style={{ position: 'absolute', right: 0, top: 32, bottom: 48, width: '25%', background: '#111118', borderLeft: '1px solid rgba(255,255,255,0.06)', padding: 10 }}>
        <div style={{ fontSize: 9, color: 'var(--fg-tertiary)', marginBottom: 8 }}>Animation</div>
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#0e0e14', borderRadius: 14, overflow: 'hidden', padding: 20, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
        ...
        <div>
          <div style={{ fontSize: 11, color: 'var(--fg-primary)', fontWeight: 600 }}>SEO Analyzer</div>
          <div style={{ fontSize: 8, color: 'var(--fg-tertiary)' }}>Paste a video URL to analyze</div>
        </div>
      ...
      <div style={{ marginBottom: 12 }}>
        <div style={{ fontSize: 9, color: 'var(--fg-tertiary)', marginBottom: 4 }}>Video Title</div>
        <div style={{ width: '100%', height: 32, borderRadius: 6, background: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', padding: '0 10px' }}>
          <div style={{ fontSize: 10, color: 'var(--fg-secondary)' }}>10 AI Tools That Will Change Your Life in 2026</div>
        </div>
      </div>
      {/* Description input */}
      <div style={{ marginBottom: 16 }}>
        <div style={{ fontSize: 9, color: 'var(--fg-tertiary)', marginBottom: 4 }}>Description</div>
        <div style={{ width: '100%', height: 48, borderRadius: 6, background: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.08)', padding: 10 }}>
          <div style={{ width: '95%', height: 5, borderRadius: 2, background: 'var(--bg-secondary)', marginBottom: 5 }} />
          <div style={{ width: '80%', height: 5, borderRadius: 2, background: 'var(--bg-secondary)', marginBottom: 5 }} />
          <div style={{ width: '60%', height: 5, borderRadius: 2, background: 'var(--bg-secondary)' }} />
        </div>
      </div>
      {/* Score bars */}
        ...
        {scores.map(s => (
          <div key={s.label}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
              <div style={{ fontSize: 9, color: 'var(--fg-secondary)' }}>{s.label}</div>
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#0e0e14', borderRadius: 14, overflow: 'hidden', padding: 20, display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div>
          <div style={{ fontSize: 11, color: 'var(--fg-primary)', fontWeight: 600 }}>Free YouTube Tools</div>
          <div style={{ fontSize: 8, color: 'var(--fg-tertiary)' }}>No signup required</div>
        </div>
        <div style={{ height: 24, width: 120, borderRadius: 6, background: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', padding: '0 8px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, flex: 1 }}>
        {tools.map(t => (
          <div key={t.name} style={{
            ...
            <div style={{ fontSize: 8, color: 'var(--fg-secondary)', textAlign: 'center' }}>{t.name}</div>
          </div>
        ))}
      </div>
    </div>
...
export function ProductDemo() {
  ...
  return (
    <section style={{ padding: '80px 20px', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <h2 style={{ fontSize: 'clamp(24px, 5vw, 36px)', fontWeight: 800, color: 'var(--fg-primary)', textAlign: 'center', marginBottom: 8 }}>
        One Platform for Everything YouTube
      </h2>
      <p style={{ fontSize: 'clamp(14px, 3.5vw, 16px)', color: 'var(--fg-secondary)', textAlign: 'center', marginBottom: 40 }}>
        Everything you need to create, optimize, and grow your channel
      </p>

      {/* Tab pills */}
      <div role="tablist" aria-label="Product demos" className="product-demo-tabs" style={{ display: 'flex', justifyContent: 'center', gap: 8, marginBottom: 32, flexWrap: 'wrap' }}>
        {PRODUCTS.map((p, i) => (
          <button
            key={p.id}
            role="tab"
            ...
            onKeyDown={(e) => {
              if (e.key === 'ArrowRight' || e.key === 'ArrowLeft') {
                ...
                switchTab(next);
                const el = document.getElementById(`product-tab-${PRODUCTS[next].id}`);
                el?.focus();
              }
            }}
            style={{
            padding: '10px 20px', borderRadius: 10,
            border: active === i ? '1px solid var(--color-brand-500, #6366f1)' : '1px solid var(--border-default, rgba(255,255,255,0.08))',
            background: active === i ? 'rgba(99,102,241,0.1)' : 'transparent',
            color: active === i ? 'var(--color-brand-500, #818cf8)' : 'var(--fg-secondary, rgba(255,255,255,0.5))',
      ...
      {/* Mockup area — decorative product screenshot, intentionally dark regardless of theme */}
      <div
        role="tabpanel"
        id={`product-panel-${product.id}`}
        aria-labelledby={`product-tab-${product.id}`}
        className="product-demo-card"
        style={{
        ...
        <div className="product-demo-desc" style={{
          ...
          <h3 style={{ fontSize: 'clamp(20px, 4vw, 28px)', fontWeight: 700, color: 'var(--fg-primary)', marginBottom: 12 }}>
            {product.title}
          </h3>
          <p style={{ fontSize: 15, color: 'var(--fg-secondary)', lineHeight: 1.7, marginBottom: 24 }}>
            {product.desc}
          </p>
