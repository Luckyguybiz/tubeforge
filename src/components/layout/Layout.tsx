...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div className="tf-app-shell" style={{ width: '100%', height: '100dvh', background: C.bg, fontFamily: "'Instrument Sans',sans-serif", color: C.text, display: 'flex', overflow: 'hidden' }}>
        {!isEditor && <Sidebar />}
