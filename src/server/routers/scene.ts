  ...
  update: protectedProcedure
    .input(
      z.object({
        ...
        model: z.enum(['turbo', 'standard', 'pro', 'cinematic', 'runway-gen3-turbo', 'runway-gen3', 'kling-v1', 'kling-v1-pro', 'kling-3.0', 'kling-2.5-turbo', 'kling-motion', 'sora-2', 'minimax-hailuo', 'google-veo', 'seedance', 'wan']).optional(),
