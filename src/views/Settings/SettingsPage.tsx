  ...
  return (
    <div style={{ maxWidth: 700, width: '100%', margin: '0 auto', padding: '0 16px', boxSizing: 'border-box' }}>
      ...
      <div className="tf-settings-section" style={sectionStyle}>
        ...
        <div className="tf-settings-theme-toggle" style={{
          display: 'inline-flex',
          alignItems: 'center',
          gap: 0,
          padding: '3px',
      ...
      <div className="tf-settings-section" style={sectionStyle}>
        ...
        <div className="tf-settings-lang-toggle" style={{
          display: 'inline-flex',
          alignItems: 'center',
          gap: 0,
          padding: '3px',
        ...
        <div className="tf-settings-section" style={sectionStyle}>
          ...
          <div style={{
            ...
            {['Google Workspace', 'Okta', 'Azure AD'].map((provider) => (
              <div key={provider} className="tf-settings-sso-row" style={{
                display: 'flex',
                alignItems: 'center',
                gap: 12,
                padding: '14px 16px',
      ...
      {/* ====================================================== */}
      <div className="tf-settings-section tf-settings-danger-zone" style={{
        ...sectionStyle,
    ...
    <div className="tf-settings-section" style={sectionStyle}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {items.map(({ key, label, desc }) => (
          <div
            key={key}
            className="tf-settings-email-row"
            style={{
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'space-between',
...
function WrappedSection({
  ...
  return (
    <div className="tf-settings-section" style={sectionStyle}>
      ...
      <div className="tf-settings-wrapped-grid" style={{
        display: 'grid',
