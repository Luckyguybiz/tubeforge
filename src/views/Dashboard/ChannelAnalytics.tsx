  ...
  if (channelsQuery.isError) {
    return (
      <div style={{
        ...
        <p style={{ color: C.sub, fontSize: 14, margin: '0 0 4px' }}>Connect your YouTube channel</p>
        <p style={{ color: C.dim, fontSize: 12, margin: 0 }}>Link your Google account to see channel analytics</p>
      </div>
    );
  }
  ...
  if (channels.length === 0) {
    return (
      <div style={{
        ...
        <p style={{ color: C.sub, fontSize: 14, margin: 0 }}>No YouTube channels found. Make sure your Google account has a YouTube channel.</p>
      </div>
    );
  }
