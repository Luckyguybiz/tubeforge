...
export function ImageGenerator() {
  ...
  const pillStyle = useMemo(() => (active: boolean): React.CSSProperties => ({
    ...
    borderRadius: 20,
    border: 'none',
    background: active ? `${GRADIENT[0]}25` : C.surface,
                ...
                <div className="tf-imggen-action-btns" style={{ display: 'flex', gap: 8, marginTop: 12, flexWrap: 'wrap' }}>
                  <button
                    ...
                    style={{
                      ...
                      background: hoveredBtn === 'download' ? C.border : C.surface,
                      color: C.text,
                  ...
                  <button
                    ...
                    style={{
                      flex: 1, minWidth: 120, padding: '10px 16px', borderRadius: 10,
                      height: 44, border: 'none',
                      background: hoveredBtn === 'use' ? C.border : C.surface,
                      color: C.text,
                      fontSize: 13, fontWeight: 600, cursor: 'pointer',
                      transition: 'all 0.2s ease', fontFamily: 'inherit',
                      display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                  ...
                  <button
                    ...
                    style={{
                      flex: 1, minWidth: 120, padding: '10px 16px', borderRadius: 10,
                      height: 44, border: 'none',
                      background: hoveredBtn === 'regen' ? C.border : C.surface,
                      color: C.text,
                      fontSize: 13, fontWeight: 600, cursor: 'pointer',
                      transition: 'all 0.2s ease', fontFamily: 'inherit',
                      display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
