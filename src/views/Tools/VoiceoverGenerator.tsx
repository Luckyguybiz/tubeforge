  ...
  return (
    ...
    >
            ...
            <button
              ...
              style={{
                ...
                background: engine === eng
                  ? 'rgba(59,130,246,.15)'
                  : hoveredEngine === eng ? '#e8e8ed' : '#f5f5f7',
                color: engine === eng ? '#3b82f6' : '#1d1d1f',
      ...
      <div style={{
        ...
        background: engine === 'elevenlabs' ? 'rgba(59,130,246,.06)' : '#f5f5f7',
        border: engine === 'elevenlabs' ? '1px solid rgba(59,130,246,.15)' : 'none',
        fontSize: 13, color: engine === 'elevenlabs' ? '#3b82f6' : '#86868b', lineHeight: 1.6,
